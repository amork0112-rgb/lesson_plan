...
const INITIAL_ROWS: CurriculumRow[] = [
  { level: 'G1', duration: '3month', mainTB: 'Phonics Show 1/ Readers', speaking: 'I can speak English  S1' },
  { level: 'G2', duration: '3month', mainTB: 'Phonics  Friends 2', speaking: 'I can speak English S 2', voca: 'Voca point 1' },
  { level: 'G3', duration: '3month', mainTB: 'Phonics Show 4', speaking: 'I can speak English  1', voca: 'Voca point 2' },
  { level: 'A1a', duration: '3month', mainTB: 'WS Starter 1', speaking: 'I can speak English  2', voca: 'Voca point 3' },
  { level: 'A1a', duration: '3', mainTB: 'WS Starter 3', speaking: 'I can speak English  3', voca: 'Voca point 4' },
  { level: 'A1b', duration: '3', mainTB: 'WS Basic 2', secondTB: 'Tropy 9 1C1 \nTropy 9 1C2', speaking: 'Everyone Speak Kids 3', voca: '200words 3', certify: 'Red' },
  { level: 'A1b', duration: '3', mainTB: 'WS Basic 3', secondTB: 'Tropy 9 1C3 \nTropy 9 2A1' },
  { level: 'A2a', duration: '3', mainTB: 'All new very \nesay true stories(8u)', secondTB: 'Tropy 9 2A3 \nTropy 9 2B1', grammar: 'Grammar point 1', writing: '5W1H', certify: 'orange' },
  { level: 'A2a', duration: '3', mainTB: 'WS  Intermediate 1', secondTB: 'Tropy 9 2B3 \nTropy 9 2C1', grammar: 'Grammar point 2', writing: 'tense writing 1-1' },
  { level: 'A2b', duration: '3', mainTB: 'WS  Intermediate 2', secondTB: 'Tropy 9 2C3 \nTropy 9 3A1', grammar: 'Grammar point 3', writing: 'paragrah writing', certify: 'Yellow' },
  { level: 'A2b', duration: '3', mainTB: 'WS  Intermediate 3', secondTB: 'Tropy 9 3A3 \nTropy 9 3B1', grammar: 'Grammar point 4', writing: 'tense writing 2-1' },
  { level: 'A3a', duration: '3', mainTB: 'True stories 1B', secondTB: 'Tropy 9 3B2 \nTropy 9 3C1', grammar: 'Aha Grammar 2 \n(My First Grammar 2)', writing: 'Andover Writing 1', certify: 'Green' },
  { level: 'A3a', duration: '3', mainTB: 'Our world 4A', secondTB: 'Tropy 9 3C2 \nTropy 9 3C3' },
  { level: 'A3b', duration: '3', mainTB: 'Subject link 4', secondTB: 'Tropy 9 4A1 \nTropy 9 4A2', grammar: 'Aha Grammar 3 \n(My First Grammar 3)', writing: 'Andover Writing 2', certify: 'Blue' },
  { level: 'A3b', duration: '3', mainTB: 'Our world 5A', secondTB: 'Tropy 9 4A3 \nTropy 9 4B1' },
  { level: 'A4a', duration: '3', mainTB: 'Reading Juice Plus 1', secondTB: 'Tropy 9 4B2/ 4B3', grammar: 'My next Grammar 1 \n(Gramamr Success1)', writing: 'Andover Writing 3', certify: 'Indigo' },
  { level: 'A4a', duration: '3', mainTB: 'Brick Reading 300-2', secondTB: 'Tropy 9 4C1/ 4C2' },
  { level: 'A4b', duration: '3', mainTB: 'Ted Talks 21st 1', secondTB: 'Tropy 9 4C3/ 4C2', grammar: 'My next Grammar 2 \n(Gramamr Success1)', writing: 'Andover Writing 4', certify: 'Purple' },
  { level: 'A4b', duration: '3', mainTB: 'Junior Debate Starter \n+ Reading Success 3', secondTB: 'Tropy 9 5A1 \nTropy 9 5A2' },
  { level: 'A5', duration: '3', mainTB: 'Reading Juice Plus 3', secondTB: 'Tropy 9 5A3/ 5B1', speaking: 'M원리 / CS', grammar: 'My next Grammar 3 \n(Gramamr Success1)', writing: 'Creative Journal 1' },
  { level: 'A5', duration: '3', mainTB: 'My First Chapter Books \n(4 Books) ', secondTB: 'Tropy 9 5B2/ 5B3' },
  { level: 'F1', duration: '3', mainTB: 'Intoreading 3.1', voca: 'voca & into  (에듀스프링)', grammar: 'Grammar Engine 1', writing: 'Creative Journal 1' },
  { level: 'F1', duration: '3', voca: 'voca & into  (에듀스프링)' },
  { level: 'F2', duration: '3', mainTB: 'intoreading 3.3', secondTB: 'My First Chapter Books \n(4 Books) ', voca: 'voca & into  (에듀스프링)', grammar: 'Grammar Engine 2', writing: 'Creative Journal 2' },
  { level: 'F2', duration: '3', voca: 'voca & into  (에듀스프링)' },
  { level: 'F3', duration: '3', mainTB: 'intoreading 4.1', secondTB: 'AMI Presentation Starter \n+Reading Success 4)', voca: 'voca & into  (에듀스프링)', grammar: 'Grammar Engine 3' },
  { level: 'F3', duration: '3', voca: 'voca & into  (에듀스프링)' },
  { level: 'M1A', duration: '3', mainTB: 'Subject link 5', secondTB: 'Korean Curriculum \n-Social Studies \n& Science (5Gr+6Gr)', speaking: 'M원리 / CS', voca: 'voca (에듀스프링)', grammar: 'Grammar inside1', writing: 'Masters Journal 1' },
...
export default function CoursesPage() {
  ...
  const handleImportToBooks = () => {
    ...
    rows.forEach(r => {
      ...
      if (!level) return;
      const pushIf = (name?: string, category?: string) => {
      ...
      pushIf(r.mainTB, 'c_reading');
      pushIf(r.secondTB, 'c_reading');
      pushIf(r.speaking, 'c_speaking');
      pushIf(r.voca, 'c_voca');
      pushIf(r.grammar, 'c_grammar');
      pushIf(r.writing, 'c_writing');
      if (r.certify) pushIf(`SCP ${r.certify}`, 'c_speaking');
    });
                    ...
                    .map((key) => (
                      <td key={key as string} className="px-3 py-2">
                        {editing ? (
                          ...
                          <div className="text-sm text-slate-800 whitespace-pre-line">{r[key]}</div>
                        )}
                      </td>
                    ))
                  }
